      ...
      <main>
        <div className="profile-card">
          ...
          <div className="social-icons">
            <a href="https://www.linkedin.com/<ADD_ID>" target="_blank" rel="noopener noreferrer">
              <FaLinkedin />
            </a>
            <a href="https://github.com/<ADD_ID>" target="_blank" rel="noopener noreferrer">
              <FaGithub />
            </a>
            <a href="https://x.com/<Add_ID>" target="_blank" rel="noopener noreferrer">
              <FaTwitter />
            </a>
          </div>
        </div>
        <div className="content">
          <h1>
            I'm <span className="highlight">Your Name</span><br/>
          </h1>
